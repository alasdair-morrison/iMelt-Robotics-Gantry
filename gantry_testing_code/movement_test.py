...
with Connection.open_serial_port("COM6") as connection:
    ...
    axis3.wait_until_idle()
      # Move to 10mm
    axis.move_absolute(125, Units.LENGTH_MILLIMETRES, wait_until_idle=False)
    axis2.move_absolute(125, Units.LENGTH_MILLIMETRES, wait_until_idle=False)
    axis3.move_absolute((50), Units.LENGTH_MILLIMETRES, wait_until_idle=False)
    axis.wait_until_idle()
    axis2.wait_until_idle()
    axis3.wait_until_idle()
    # Move by an additional 5mm
    axis.move_relative(120, Units.LENGTH_MILLIMETRES, wait_until_idle=False)
    axis2.move_relative(120, Units.LENGTH_MILLIMETRES, wait_until_idle=False)
    axis3.move_relative(50, Units.LENGTH_MILLIMETRES, wait_until_idle=False)
    axis.wait_until_idle()
    axis2.wait_until_idle()
    axis3.wait_until_idle()
    axis.move_absolute(0, Units.LENGTH_MILLIMETRES, wait_until_idle=False)
